...
app.config["MONGO_URI"] = "mongodb+srv://yedlalikithareddy2104:Likitha0102@cluster.ihmt8jh.mongodb.net/bharatsaga"
mongo = PyMongo(app)

# Groq API configuration
GROQ_API_KEY = "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"
